...
Так, в даному випадку ми можемо змінити об'єкт який оголошений за допомогою const так як ми змінюємо властивість самого обєкта а не перевизначаємо const або обєкт на який вона посилається
